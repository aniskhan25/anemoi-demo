...
- [ ] Record container path, module state, and LUMI paths in `notes/environment.local.md`.
- [ ] Run [scripts/validate_install.sh](/Users/anisrahm/Documents/anemoi-demo/scripts/validate_install.sh).

## WP2: Minimal Data Path
