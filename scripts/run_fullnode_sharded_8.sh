...
export ANEMOI_DISTRIBUTED_STRATEGY="${ANEMOI_DISTRIBUTED_STRATEGY:-fsdp}"
export ANEMOI_NODES="${ANEMOI_NODES:-8}"
...
exec bash "${ROOT_DIR}/scripts/run_fullnode_production.sh"
